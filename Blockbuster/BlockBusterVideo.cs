...
namespace Blockbuster
{
    class BlockBusterVideo
    {
        ...
        public BlockBusterVideo()
        {
            ...
            DVD d = new DVD();
            Movie m1 = new Movie("Shrek", Genre.Comedy, 90, shrekScenes, d);
            ...
            //DVD d2 = new DVD();
            Movie m2 = new Movie("Mean girls", Genre.Drama, 90, meanGirls, d);
            ...
            //VHS v2 = new VHS();
            Movie m4 = new Movie("Lord of the Rings", Genre.Drama, 210, lordOfTheRingsScenes, v);
